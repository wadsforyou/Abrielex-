      ...
      <section className="border-b border-border bg-muted/30">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            Five core categories of professional business solutions. Open any dossier for full
            details — what it is, who it's for, requirements, process and how to request it.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="mb-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            <SectionHeading eyebrow="All services" title="Browse by category" />
